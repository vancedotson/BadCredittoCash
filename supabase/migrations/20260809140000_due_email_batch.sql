...
begin
  ...
  -- A terminated invocation can leave a row claimed. Make it eligible again;
  -- the provider idempotency key remains stable across retries.
  ...
  select claimed.id, contact.email, claimed.template_key
  from claimed
