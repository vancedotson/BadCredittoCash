  ...
  return (
    ...
    >
      <Link
        ...
        className="relative inline-flex min-h-[54px] items-center justify-center gap-2.5 overflow-hidden rounded-full bg-gold py-3 pl-3 pr-7 font-heading text-[17px] font-semibold text-ink shadow-card outline-none transition-all duration-200 hover:scale-[1.02] hover:bg-gold-deep focus-visible:ring-2 focus-visible:ring-white/80"
      >
      ...
      <Link
        ...
        className="group inline-flex items-center gap-2 rounded-full font-heading text-[15px] font-semibold text-white/85 outline-none transition-colors hover:text-gold focus-visible:ring-2 focus-visible:ring-white/70"
      >
