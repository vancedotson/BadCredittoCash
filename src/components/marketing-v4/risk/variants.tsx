...
/* Terms Panel — headline + glass case-terms document; each clause expands on
   hover/focus to reveal a short calming line. */
    ...
    <div className="v3-wrap grid items-start gap-12 lg:grid-cols-[0.9fr_1.1fr]" ref={ref}>
      <div>
        ...
        <Reveal as="h2" className="v3-display mt-5">
          <span style={{ fontSize: "clamp(38px,6vw,72px)", maxWidth: 520, display: "block" }}>
            You&apos;ve got{" "}
      ...
      <Reveal className="v3-panel v3-clip v3-corner relative p-8 sm:p-10" delay={1}>
        <div
