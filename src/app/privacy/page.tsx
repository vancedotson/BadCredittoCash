  ...
  return (
    ...
    >
      ...
      <LegalSection title="Information we collect">
        <ul>
          <li><strong>Contact and registration information:</strong> name, email address, optional phone number, and the source of your inquiry.</li>
        ...
        <p>
          Please do not send Social Security numbers, full credit reports, account passwords, or other highly sensitive information through the public website forms or ordinary email unless we provide a secure method and specifically ask for it.
        </p>
      </LegalSection>
